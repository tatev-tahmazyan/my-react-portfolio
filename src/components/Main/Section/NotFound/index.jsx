                ...
                <g id="train">
                  ...
                  <g id="car-layers">
                    ...
                    <g id="Text">
                      ...
                      <text transform="translate(659.5 208.994)" className="st8 st10" fontSize="24.025">
                      Page not found.
                      </text>
                      <text transform="translate(760.5 219.994)">
                        <Link to="/" className="st8 st10" fontSize="12">Home page</Link>
                      </text>
                    </g>
                    <g id="ladders">
                      <g id="ladder-f">
